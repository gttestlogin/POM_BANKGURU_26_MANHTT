...
public class Account_10_RegisterAndLogin_ElementUndisplayed extends AbstractTest {	
	@Parameters("browser")
	@BeforeClass
	...
	public void TC_01_RegisterToSystem() {		
		log.info("REGISTER - STEP: 1.1 Verify Home Page is displayed");
		Assert.assertTrue(loginPage.isLoginPageDisplayed());
		
		//co trong DOM nhung khong hien tren UI
		log.info("REGISTER - STEP: 1.2.1 Verify Delete Customer Form is not displayed");
		Assert.assertTrue(loginPage.isDeleteCustomerFormLinkUndisplayed());

		log.info("REGISTER - STEP: 1.2.2 Click to Selenium Dropdown Toggle");
		loginPage.clickToSeleniumDropdownToggle();

		log.info("REGISTER - STEP: 1.2.3 Verify Delete Customer Form is displayed (after click to Selenium)");
		// ASSERT - sai -> skip luon TC
		//Assert.assertTrue(loginPage.isDeleteCustomerFormLinkDisplayed());
		// Demo FAILED: VERIFY - sai -> chỉ qua bỏ step này
		verifyFalse(loginPage.isDeleteCustomerFormLinkDisplayed());
		
		log.info("REGISTER - STEP: 1.3 Verify Home Page is not displayed");
		Assert.assertTrue(loginPage.isHomePageUndisplayed());

		log.info("REGISTER - STEP: 1.4 Verify Register Page is not displayed");
	...
	public void TC_03_OpenMultiplePage() {
		log.info("Action Chain - Step 1: Home Page navigates to New Customer Page");
		...
		log.info("Action Chain - Step 2: New Customer Page navigates to Deposit Page");
		...
		log.info("Action Chain - Step 3: Deposit Page navigates to New Account Page");
		...
		log.info("Action Chain - Step 4: New Account Page navigates to Home Page");
		//homePage = newAccountPage.openHomePage(driver);
		newAccountPage.openMultiplePage(driver, "New Account");
		homePage = PageGeneratorManager.getHomePage(driver);

		
		log.info("Action Chain - Step 5: Home Page navigates to Deposit Page");
		...
		log.info("Action Chain - Step 6: Deposit Page navigates to New Customer Page");
		//newCustomerPage = depositPage.openNewCustomerPage(driver);
		depositPage.openMultiplePage(driver, "New Customer");
		newCustomerPage = PageGeneratorManager.getNewCustomerPage(driver);

		log.info("Action Chain - Step 7: New Customer Page navigates to Home Page");
