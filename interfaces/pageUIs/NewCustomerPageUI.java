...
public class NewCustomerPageUI {
	...
	public static final String CUSTOMER_ID_IN_TABLE = "//td[text()='Customer ID']/following-sibling::td";
	public static final String CUSTOMER_NAME_IN_TABLE = "//td[text()='Customer Name']/following-sibling::td";
	public static final String GENDER_VALUE_IN_TABLE = "//td[text()='Gender']/following-sibling::td";
	public static final String DATE_OF_BIRTH_VALUE_IN_TABLE = "//td[text()='Birthdate']/following-sibling::td";
